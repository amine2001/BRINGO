...
export function ConfirmSubmitButton({
  ...
  useEffect(() => {
    ...
    const previousDialogState = document.body.dataset.confirmDialogOpen;
    document.body.style.overflow = "hidden";
    document.body.dataset.confirmDialogOpen = "true";
    ...
    return () => {
      ...
      if (previousDialogState) {
        document.body.dataset.confirmDialogOpen = previousDialogState;
      } else {
        delete document.body.dataset.confirmDialogOpen;
      }
