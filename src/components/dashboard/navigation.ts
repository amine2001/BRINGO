...
> = {
  ...
  ar: [
    { label: "نظرة عامة", description: "مركز قيادة العمليات" },
    { label: "المتاجر", description: "توجيه المتاجر وأنواع التوصيل" },
    { label: "مجموعات تيليغرام", description: "وجهات الدردشة والربط" },
    { label: "سير العمل", description: "المراحل والتوقيتات وقواعد التذكير" },
    { label: "إعدادات التأخير", description: "حدود تنبيهات الإدارة" },
    { label: "API", description: "إعدادات اتصال Redash" },
    { label: "الوصول", description: "إدارة المستخدمين والصلاحيات" },
    { label: "الإعدادات", description: "اللغة والمظهر" },
  ],
  pt: [
