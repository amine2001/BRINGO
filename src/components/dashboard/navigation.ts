...
> = {
  ...
  ar: [
    { label: "Overview", description: "لوحة متابعة العمليات" },
    { label: "Stores", description: "اعدادات المتاجر وانواع التوصيل" },
    { label: "Telegram", description: "مجموعات التليجرام والربط" },
    { label: "Workflow", description: "مراحل التنبيه والتوقيت" },
    { label: "Delays", description: "عتبات تاخر الادمن" },
    { label: "API", description: "اعدادات Redash" },
    { label: "Access", description: "المستخدمون والصلاحيات" },
    { label: "Settings", description: "اللغة والثيم" },
  ],
  pt: [
